...
func TestCountingBloomfilter(t *testing.T) {
	...
	// create BloomFilter
	bf := NewCountingBloomFilter(n, fpRate)
...
func TestCountingBloomfilterSerialize(t *testing.T) {
